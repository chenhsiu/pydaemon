...
class DaemonRunner:
    ...
    def __init__(self, app):
        ...
        self.daemon_context.stdout = open(app.stdout_path, 'at+', buffering=1) # support python3.5 line buffering
        self.daemon_context.stderr = open(app.stderr_path, 'at+', buffering=1)
