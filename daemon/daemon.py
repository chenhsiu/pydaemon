...
class DaemonContext:
    ...
    def interrupt(self, signal_number, stack_frame):
        print("Interrupt on signal {signal_number!r}".format(signal_number=signal_number))
        self.grace_shutdown = True
